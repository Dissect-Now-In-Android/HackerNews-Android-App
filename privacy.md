PRIVACY POLICY FOR MOBILE APPLICATION "Hacker News"
Last updated: Jan 15, 2024

This privacy policy governs your use of the software application “Hacker News” (later referred as the/this “Application”) for Android™ mobile devices that was created by Matthew Tong.

The Application is a mobile Android application intended to Hacker News you specificed using the camera on the phone.
...
The only User Provided Data that this Application uses is the information you provide directly within the Application when searching words using the camera on the phone.
...
Changes
This Privacy Policy may be updated from time to time for any reason. We will notify you of any changes to our Privacy Policy by posting the new Privacy Policy at [https://github.com/findword-app/static-content/privacy.md](https://github.com/findword-app/static-content/blob/main/privacy.md) and update the "Last updated" date at the top of this Privacy Policy.
...
contact [dot] dissect4 [at] gmail [dot] com
